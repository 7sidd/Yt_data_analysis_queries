...
## Repository Files
*   `IN_Trending.csv`: The raw YouTube India historical dataset.
...
*   **Language:** SQL (Window Functions, Aggregations, Common Table Expressions, Regex Parsing, Date Functions)
